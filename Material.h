...
public:
	...
	{
		return const_cast<T&>(static_cast<const Material*>(this)->Get(name));
	}
	...
	{
		return const_cast<T*>(static_cast<const Material*>(this)->TryGet(name));
	}

	bool HasProperty(std::string_view name)
	{
